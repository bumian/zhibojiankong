...
if __name__ == '__main__':
    ...
    for pf in platform:
        ...
        # 获取当前榜单数据保存到redis
        lives_all = pf_ins.traverse_living("live",10000)  # 当前热门榜
